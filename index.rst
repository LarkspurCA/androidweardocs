...
Android 4.4 (KitKat) for handheld and wearable devices was introduced at Google I/O 2014, along with an Android Studio version that included features specific to wearables. Since then, Google has released Android 5.0 (Lollipop) and Android Studio 1.0,

The first devices to take advantage of Lollipop are Android watches. Users can now choose from a wider array of watch faces, and developers can add watch faces that support their app. Besides just displaying time in an interesting way, the watch face can now display app information like upcoming appointments. 
